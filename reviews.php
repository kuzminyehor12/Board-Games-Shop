...
<header>
    ...
    <main>
        <div class="review-wrapper">
            <?php 
                    $reviews = query_to_array("SELECT * FROM `reviews`");
                    reviewGenerator($reviews);
            ?>
            <div class="review-container">
                <form action="php/reviews_to_db.php" method="post" class="review-from">
                    <label for="review">Напишите отзыв:</label><br>
                    <div class="form-input_group">
                        <textarea name="review" id="review" cols="110" rows="10"></textarea>
                    </div>
                    <button style="padding: 10px 5px; margin-top: 5px" type="submit">Оставить отзыв</button>
                </form>
            </div>
        </div>
    </main>
